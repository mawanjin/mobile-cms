...
<div class="page_sign">
    <div class="animation_sign">
        ...
        <div class="tank">
            ...
            <h1 class="btn_a" href="${ctx}/my/do_activity_sign.do">活动签到</h1>
            <c:if test="${not empty result}">
                <c:choose>
                    <c:when test="${result.pointVal > 0}">
                        ...
                        <h3>积点领取</h3>
                        <c:set var="sign_message" value="领取积点${result.pointVal}点"/>
                    </c:when>
                    <c:when test="${result.trafficVal > 0}">
                        <h2>${result.trafficVal}M</h2>

                        <h3>流量领取</h3>
                        <c:set var="sign_message" value="领取流量${result.trafficVal}M"/>
                    </c:when>
