...
public class ThumbnailCommand extends Command {
    ...
    /**
     * Backup map holding mime types for images just in case if they aren't set in request
     */
    ...
    /**
     * Validates parameters and access rights.
     *
     * @throws com.ckfinder.connector.errors.ConnectorException if validation fails.
     */
     ...
     * response code.
     * @throws com.ckfinder.connector.errors.ConnectorException when access is denied.
     */
