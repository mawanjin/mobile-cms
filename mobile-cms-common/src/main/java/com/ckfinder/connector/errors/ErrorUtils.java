...
public final class ErrorUtils {
	...
	/**
	 * Returns or creates and returns errorUtil instance.
	 *
	...
	/**
	 * Gets language codes from jar file holding language files.
	 *
	 * @return List with language codes.
	 */
	...
	/**
	 * Adds language codes to list.
	 *
	 * @param mountJar Mounted source file.
	 * @param jarFile Virtule jar file.
	 * @param langFiles List of string codes for languages.
	 */
	...
	/**
	 * Checks if jar entry is lang file.
	 *
	...
	/**
	 * Gets language messages from file.
	 *
	 * @param langCode language code.
	 * @return map of language messages.
	 */
