...
public class ConnectorServlet extends HttpServlet {
     ...
     *
     * @param request request
     * @throws com.ckfinder.connector.errors.ConnectorException when param isn't set or has wrong value.
     */
     ...
     * @throws javax.servlet.ServletException when error handling fails.
     */
