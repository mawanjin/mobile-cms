...
public class Configuration implements IConfiguration {
    ...
    /**
     * Sets ACL configuration as a list of access controll levels.
     *
    ...
    /**
     * Creates single resource type configuration from XML configuration file (from XML element
     * 'type').
     *
    ...
    /**
     * Gets a list of resource types (in same order as in configuration).
     *
     * @return ordered list resource types.
     */
    ...
    /**
     * Checks if configuration should be reloaded. It is reloaded when date of
     * file modifiation is greater then date of last config initialization.
     *
    ...
    /**
     * Sets thums directory used by ConfigurationFacotry.
     *
    ...
    /**
     * Clones currnet configuratuion instance and copies it's all fields.
     *
     ...
     * method should be overriden and return new configuration instnce.
     *
