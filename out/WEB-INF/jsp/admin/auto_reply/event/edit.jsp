...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                <form:form action="${ctx}/save.do" method="post" class="form-horizontal validate_frm">
                    <form:hidden path="id"/>
                    <input type="hidden" value="${dlgResult}" name="dlgResult" id="dlgResult"/>
                    <form:hidden path="type"/>
                    <div class="form-group">
                        <form:label path="eventKey" class="col-sm-3 control-label no-padding-right">动作:</form:label>
                        <div class="col-sm-9">
                            <form:select path="eventKey">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <a class="ajax btn icon-hand-up"
                               href="${ctxRoot}/admin/cms/dialog.do?childAjax=false&multi=false&existIds=${dlgResult}&type=<%=CmsContentType.Text%>">
                                选择
                            </a>
