    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="blue bigger">编辑投票[${command.poll.node.title}]的选项</h4>
            </div>
            <form:form id="primary" action="${ctx}/poll/option/save.do" method="post" class="form-horizontal validate_frm">
                <div class="modal-body">
                    <div class="row">
                        <form:hidden path="id"/>
                        <form:hidden path="poll.id"/>
                        <div class="form-group">
                            <label  class="col-sm-4 control-label  no-padding-right">投票选项标题:</label>
                            <div class="col-sm-8">
                        ...
                        <c:if test="${command.poll.type eq 'SurveyScore'}">
                            <div class="form-group">
                                <label  class="col-sm-4 control-label  no-padding-right">分数:</label>
                                <div class="col-sm-8">
                                    <form:input class="input-large required" path="score"/>
                                </div>
                            </div>
                        </c:if>
                    </div>
