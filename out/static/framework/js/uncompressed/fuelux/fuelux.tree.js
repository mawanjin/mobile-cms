			...
			this.options.dataSource.data($el.data(), function (items) {
				...
				$.each( items.data, function(index, value) {
					...
					if(value.type === "folder") {
						...
						header.data(value);
                        if(self.options.folderSelected){
                            $entity.on("click", value, self.options.folderSelected);
                        }
						...
						$entity.data(value);
                        if(self.options.itemSelected){
                            $entity.on("click", value, self.options.itemSelected);
                        }
